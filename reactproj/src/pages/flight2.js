                ...
                <form  onSubmit={handleSubmit }className="flight-search-form">
                    ...
                    <div className="row">
                        <div className="form-group col-lg-4 ui-widget">
                            ...
                            <input required type="text" name="origin_name" placeholder="Departure City..." className="form-control" id="osearch" value={origin_name} onChange={(event) => setorigin_name(event.target.value)} />
                        </div>
                        <div className="form-group col-lg-4 ui-widget">
                            <label htmlFor="dest_name">To</label>
                            <input required type="text" name="dest_name" placeholder="Destination City..." className="form-control" id="dsearch" value={dest_name} onChange={(event) => setdest_name(event.target.value)}/>
                        </div>
                        <div className="form-group col-lg-4">
                            <label htmlFor="date">Departure date</label>
                            <input required type="date" name="date" className="form-control" id="form-depart" value={date} onChange={(event) => setdate(event.target.value)} style={{ height: "60px" }} />
                        </div>
                    </div>
                    <br />
